...
from assemlm.legacy.v1.model.tools import FRAMEWORK_REGISTRY
from assemlm.legacy.v1.training.trainer_utils import initialize_overwatch
...
class AssemLMHF(PreTrainedModel):
    ...
    def __init__(self, config: AssemLMHFConfig, **kwargs):
        ...
        from assemlm.legacy.v1.model.modules.pose_head import get_action_model
        from assemlm.legacy.v1.model.modules.assemlm import get_assemlm_model
    ...
    #     from assemlm.legacy.v1.model.framework.base_framework import baseframework
