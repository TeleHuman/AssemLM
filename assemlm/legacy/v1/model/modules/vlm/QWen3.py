...
_ACTION_TOKEN_MAX = 153984 # here only for fast_tokenizer; see the fast-tokenizer README
...
class _QWen3_VL_Interface(nn.Module):
    ...
    def build_qwenvl_inputs(self, images, instructions, solutions=None, **kwargs):
        ...
        if solutions is not None: #  here only for fast_tokenizer now. 
            ...
            action_token_max = _ACTION_TOKEN_MAX # here only for fast_tokenizer; see the fast-tokenizer README
            ...
            for i in range(labels.size(0)):
                ...
                if nonzero_indices.numel() > 0:
                    ...
                    seq[:] = IGNORE_INDEX
                    RuntimeWarning ("Action tokens are enabled in the tokenizer; see the fast-tokenizer README.")
