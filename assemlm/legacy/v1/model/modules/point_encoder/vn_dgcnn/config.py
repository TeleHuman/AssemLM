...
_C.exp.debug          = False
_C.exp.wandb_entity   = ''
_C.exp.wandb_project  = ''
_C.exp.wandb_run_name = ''
_C.exp.wandb_api_key  = ''
_C.exp.save_freq      = 100
_C.exp.val_freq       = 100
...
_C.model.loss_weight_point = 0.0
_C.model.loss_weight_rot = 1.0
_C.model.loss_weight_trans = 1.0
_C.model.loss_weight_recon = 1.0
